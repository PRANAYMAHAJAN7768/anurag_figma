...
const variants = {
  outline: {
    deep_purple_600: "border-deep_purple-600 border-2 border-solid text-deep_purple-600",
  },
  fill: {
    deep_purple_600: "bg-deep_purple-600 shadow-xs text-gray-50",
    deep_purple_50: "bg-deep_purple-50",
    orange_300: "bg-orange-300 text-gray-900_02",
    gray_100: "bg-gray-100 shadow-3xl text-white-A700_01",
  },
};
const sizes = {
  lg: "h-[64px] px-[17px]",
